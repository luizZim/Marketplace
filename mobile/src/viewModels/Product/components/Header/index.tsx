...
import { ProductRepository } from '../../../../../../backend/src/infra/database/typeorm/market-place/repositories/product.repository';
    ...
    <>
      ...
      <View className="bg-background py-8">
        <View className="flex-row justify-between items-baseline mb-4">
          <Text className="text-xl text-gray-800 font-bold max-w-[70%]">{productDetails.name}</Text>
          <View>
            <AppPriceText value={Number(productDetails.value)} classNameValue="text-xl font-bold text-gray-800 ml-1" />
          </View>
        </View>
